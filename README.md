...
Part 2: 8th order adaptive Runge-kutta/DOPRI consists currently of celestData.py, gravity.py, stateVector.py, testMain2.py, rk4_inntegrator.py, and simulationData.py
